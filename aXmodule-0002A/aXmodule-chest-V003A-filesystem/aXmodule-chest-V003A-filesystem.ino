...
//  LINES DOWN 6 WIDE
const int monoPattern0frames = 33;
byte monoPattern0[monoPattern0frames][thisPartNoLEDs];

//  BARS ACROSS
const int monoPattern1frames = 1;
...
//  LINES DOWN 6 WIDE
const int colorPattern0frames = 25;
...
//        feedback += currentFrameNo;
        ...
        if (currentPatternNo == 0) {
            autoPattern(10, 10, 10, 2, true);
        } else if (currentPatternNo == 1) {
            autoPattern(monoPattern0frames, 25 , 10, 2, true);
        } else if (currentPatternNo == 2) {
            autoPattern(monoPattern1frames, 25, 10, 2, true);
        } else if (currentPatternNo == 3) {
            autoPattern(monoPattern2frames, 25, 10, 2, true);
            
        } else if (currentPatternNo == 4) {
            autoPattern(colorPattern0frames, 0, 10, 2, true);
        } else if (currentPatternNo == 5) {
            autoPattern(colorPattern1frames, 0, 10, 2, true);
        } else if (currentPatternNo == 6) {
            autoPattern(colorPattern2frames, 0, 10, 2, true);
        };
...
//        Serial.println(feedback);
  ...
  if (motionPaintActive) {
    autoPattern(currentPatternFramesNo, 0, 1, 0, false);
    Serial.println("go");
  };
...
void autoPattern(int numberFrames, int delayWait, int noCycles, int colourType, bool patternChanger) {
