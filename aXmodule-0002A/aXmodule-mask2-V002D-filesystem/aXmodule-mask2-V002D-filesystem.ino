...
//  LINES DOWN 6 WIDE
const int newPattern0frames = 2;
byte newPattern0[newPattern0frames][thisPartNoLEDs];

//  BARS ACROSS
const int newPattern1frames = 37;
byte newPattern1[newPattern1frames][thisPartNoLEDs];

//  LINES DOWN CENTER FIRST
const int newPattern2frames = 1;
byte newPattern2[newPattern2frames][thisPartNoLEDs];
...
//        feedback += currentFrameNo;
        ...
        if (currentPatternNo == 0) {
            autoPattern(1, 10, 10, 0);
        } else if (currentPatternNo == 1) {
            autoPattern(1, 25, 10, 0);
        } else if (currentPatternNo == 2) {
            autoPattern(37, 25, 10, 0);
        };
...
//  String thisFrameLoop = "";
  ...
  while (currentFrameNo < numberFrames) {
        ...
        if (currentPatternNo == 0) {
            ...
            runPattern(newPattern0[currentFrameNo]);
        } else if (currentPatternNo == 2) {
            runPattern(newPattern1[currentFrameNo]);
        };
