...
//  LINES DOWN 6 WIDE
byte newPattern0[34][thisPartNoLEDs];

//  BARS ACROSS
byte newPattern1[22][thisPartNoLEDs];

//  LINES DOWN CENTER FIRST
byte newPattern2[26][thisPartNoLEDs];
